...
export default function SkeletonCampaignMendesak() {
  return (
    <div className="relative border w-full hover:bg-zinc-100 transition-all duration-300 ease-in-out cursor-pointer border-zinc-200 rounded-lg p-2 animate-pulse">
      <div className="relative flex flex-col w-full space-y-3">
        {/* Image Campaign */}
        <div className="flex flex-none">
          <div className="h-28 w-full rounded-lg bg-zinc-100 animate-pulse"></div>
        </div>
        {/* Detail Campaign */}
